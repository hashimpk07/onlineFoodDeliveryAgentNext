...
export async function getCaptainCountries(): Promise<Country[]> {
  return api
    .get<ApiResponse<Country[]>>("/public/countries?show=captain")
    .then(unwrapResponse);
}
...
export async function getCaptainVehicleTypes(): Promise<FilterVehicleType[]> {
  return api
