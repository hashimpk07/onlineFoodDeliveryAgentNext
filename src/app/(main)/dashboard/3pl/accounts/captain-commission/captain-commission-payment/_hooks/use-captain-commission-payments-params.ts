...
export function useCaptainCommissionPaymentParams() {
  ...
  const isAnyFilterActive = useMemo(
    ...
    [search, fromDate, toDate, captain, paidBy, paymentType, page, per_page],
  );
  ...
  const filters = useMemo(
    ...
    [search, fromDate, toDate, captain, paidBy, paymentType],
  );
